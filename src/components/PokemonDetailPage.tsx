...
const PokemonDetailPage = ({ id, pokemon, geslacht, moveSet, type, skills, about }: Props): JSX.Element => {
    ...
    return (
        <div>
                        ...
                        <div className="flex rounded-lg flex-col items-center justify-center shadow-lg bg-white mt-1">
                            ...
                            <div className="flex w-full rounded-lg shadow-lg bg-white pt-1 justify-between gap-3 capitalize">
                               ...
                               <div className="w-28 flex py-1 px-3">
                                    {pokemon.types.map((tt: any, tkey: number) => {
                                        return (
                                            <div
                                                key={tkey}
                                                ...
                                                style={{ backgroundColor: `#${getBackgroundColorFromType(tt.type.name)}` }}
                                            >
                                                {tt.type.name}
                                            </div>
                                        );
            ...
            <div className="mx-4 md:hidden">
             ...
             border-t-4 border-gray-600 shadow-md rounded-lg capitalize
             fixed
             inset-x-0
             bottom-1
